...
module.exports = class Receive {
  ...
  handleTextMessage() {
    ...
    if (
      ...
      || message.includes("hola") || message.includes("hey") || message.includes("what") || message.includes("what a gwaan")
       || message.includes("waah gwaan") || message.includes("waa gwaan") || message.includes("wha gwaan")
